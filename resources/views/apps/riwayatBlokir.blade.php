                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="{{route('apps.riwayatblokir.detail',$riwayat['id'])}}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        {{-- <a class="btn btn-sm btn-warning" href="{{route('apps.riwayatblokir.edit',$riwayat['id'])}}">
                                            Edit
                                        </a> --}}
                                    </td>
                                </tr>
